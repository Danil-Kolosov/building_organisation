...
public partial class BuildingOrganisationContext : DbContext
{
    public BuildingOrganisationContext()
    {
    }

    public BuildingOrganisationContext(DbContextOptions<BuildingOrganisationContext> options)
        : base(options)
    {
    }
